...
//		frame.setBounds(100, 100, 800, 600);
		...
		btnInput.setBounds(46, 481, 200, 40);
		...
		btnInput.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(mid.trim().equals("")) {
					...
					JOptionPane.showMessageDialog(null,"비밀번호는 필수 입력입니다.", "회원가입창", JOptionPane.WARNING_MESSAGE);
					txtPwd.requestFocus();
